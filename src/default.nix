...
,
  ...
  if builtins ? getEnv && builtins.getEnv "d2nConfigFile" != ""
  then builtins.toPath (builtins.getEnv "d2nConfigFile")
  ...
  makeDreamLockForSource =
    ...
    let
      ...
      t =
        ...
        in
          if trans != [ ]
          then lib.elemAt trans 0
          else throw "Could not find a suitable translator for input";
  ...
  riseAndShine =
    ...
    let
      dreamLock' =
        ...
        then args.source
        else makeDreamLockForSource { inherit source translatorArgs; };
